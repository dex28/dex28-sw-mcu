...
rem copy/y lcdart.hex \\BugsBunny\root\lcdart.hex

rem D:\cygwin\bin\ssh -l root BugsBunny avrdude -q -p m8 -c avrisp -e -U flash:w:lcdart.hex:i

rem D:\cygwin\bin\ssh -l root BugsBunny ./init_lcdart
